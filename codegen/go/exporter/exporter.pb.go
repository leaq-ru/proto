...
import (
	...
	parser "github.com/leaq-ru/proto/codegen/go/parser"
...
type File struct {
	...
	Status       Status `protobuf:"varint,5,opt,name=status,proto3,enum=exporter.Status" json:"status,omitempty"`
	CurrentCount uint32 `protobuf:"varint,6,opt,name=current_count,json=currentCount,proto3" json:"current_count,omitempty"`
...
func (x *File) GetCurrentCount() uint32 {
	if x != nil {
...
func (x *File) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
var file_exporter_exporter_proto_rawDesc = []byte{
	...
	0xcb, 0x01, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	,
	...
	0x45, 0x53, 0x53, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x41, 0x49, 0x4c, 0x10, 0x04, 0x32,
	...
	0x65, 0x72, 0x2f, 0x67, 0x65, 0x74, 0x4d, 0x79, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x42, 0x2e, 0x5a,
	0x2c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x65, 0x61, 0x71,
	0x2d, 0x72, 0x75, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x6f, 0x64, 0x65, 0x67, 0x65,
	0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70,
...
var file_exporter_exporter_proto_depIdxs = []int32{
	...
	0, // 1: exporter.File.status:type_name -> exporter.Status
	2, // 2: exporter.GetMyFilesResponse.files:type_name -> exporter.File
	6, // 3: exporter.Exporter.ExportCompanies:input_type -> parser.GetListRequest
	6, // 4: exporter.Exporter.ExportCompaniesAsync:input_type -> parser.GetListRequest
	1, // 5: exporter.Exporter.GetMyFiles:input_type -> exporter.GetMyFilesRequest
	4, // 6: exporter.Exporter.ExportCompanies:output_type -> exporter.ExportCompaniesResponse
	7, // 7: exporter.Exporter.ExportCompaniesAsync:output_type -> google.protobuf.Empty
	3, // 8: exporter.Exporter.GetMyFiles:output_type -> exporter.GetMyFilesResponse
...
type ExporterClient interface {
	...
	ExportCompaniesAsync(ctx context.Context, in *parser.GetListRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *exporterClient) ExportCompaniesAsync(ctx context.Context, in *parser.GetListRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ExporterServer interface {
	...
	// available only on data-premium plan and full result returns in getMyFiles response
	ExportCompaniesAsync(context.Context, *parser.GetListRequest) (*emptypb.Empty, error)
...
func (*UnimplementedExporterServer) ExportCompaniesAsync(context.Context, *parser.GetListRequest) (*emptypb.Empty, error) {
