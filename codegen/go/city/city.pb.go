...
type CityClient interface {
	...
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CitiesResponse, error)
...
func (c *cityClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CitiesResponse, error) {
	out := new(CitiesResponse)
...
type CityServer interface {
	...
	GetAll(context.Context, *emptypb.Empty) (*CitiesResponse, error)
...
func (*UnimplementedCityServer) GetAll(context.Context, *emptypb.Empty) (*CitiesResponse, error) {
...
func _City_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CityServer).GetAll(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
