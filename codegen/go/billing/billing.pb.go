...
var file_billing_billing_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x6c, 0x65, 0x61, 0x71, 0x2d, 0x72, 0x75, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
type BillingClient interface {
	...
	RobokassaWebhook(ctx context.Context, in *RobokassaWebhookRequest, opts ...grpc.CallOption) (*wrapperspb.StringValue, error)
	RenewCompanyPremium(ctx context.Context, in *RenewCompanyPremiumRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	RenewDataPremium(ctx context.Context, in *RenewDataPremiumRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetMyBalance(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMyBalanceResponse, error)
	GetMyInvoices(ctx context.Context, in *GetMyInvoicesRequest, opts ...grpc.CallOption) (*GetMyInvoicesResponse, error)
	GetMyDataPlan(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMyDataPlanResponse, error)
	ManualDebit(ctx context.Context, in *ManualDebitRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *billingClient) RobokassaWebhook(ctx context.Context, in *RobokassaWebhookRequest, opts ...grpc.CallOption) (*wrapperspb.StringValue, error) {
...
func (c *billingClient) RenewCompanyPremium(ctx context.Context, in *RenewCompanyPremiumRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *billingClient) RenewDataPremium(ctx context.Context, in *RenewDataPremiumRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (c *billingClient) GetMyBalance(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMyBalanceResponse, error) {
...
func (c *billingClient) GetMyDataPlan(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetMyDataPlanResponse, error) {
...
func (c *billingClient) ManualDebit(ctx context.Context, in *ManualDebitRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type BillingServer interface {
	...
	RobokassaWebhook(context.Context, *RobokassaWebhookRequest) (*wrapperspb.StringValue, error)
	RenewCompanyPremium(context.Context, *RenewCompanyPremiumRequest) (*emptypb.Empty, error)
	RenewDataPremium(context.Context, *RenewDataPremiumRequest) (*emptypb.Empty, error)
	GetMyBalance(context.Context, *emptypb.Empty) (*GetMyBalanceResponse, error)
	GetMyInvoices(context.Context, *GetMyInvoicesRequest) (*GetMyInvoicesResponse, error)
	GetMyDataPlan(context.Context, *emptypb.Empty) (*GetMyDataPlanResponse, error)
	ManualDebit(context.Context, *ManualDebitRequest) (*emptypb.Empty, error)
...
func (*UnimplementedBillingServer) RobokassaWebhook(context.Context, *RobokassaWebhookRequest) (*wrapperspb.StringValue, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RobokassaWebhook not implemented")
}
func (*UnimplementedBillingServer) RenewCompanyPremium(context.Context, *RenewCompanyPremiumRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RenewCompanyPremium not implemented")
}
func (*UnimplementedBillingServer) RenewDataPremium(context.Context, *RenewDataPremiumRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RenewDataPremium not implemented")
}
func (*UnimplementedBillingServer) GetMyBalance(context.Context, *emptypb.Empty) (*GetMyBalanceResponse, error) {
...
func (*UnimplementedBillingServer) GetMyDataPlan(context.Context, *emptypb.Empty) (*GetMyDataPlanResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMyDataPlan not implemented")
}
func (*UnimplementedBillingServer) ManualDebit(context.Context, *ManualDebitRequest) (*emptypb.Empty, error) {
...
func _Billing_GetMyBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).GetMyBalance(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Billing_GetMyDataPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BillingServer).GetMyDataPlan(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
