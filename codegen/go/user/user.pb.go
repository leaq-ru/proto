...
var file_user_user_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0xb4, 0x01, 0x0a,
	...
	0x72, 0x65, 0x63, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x68, 0x6f, 0x74, 0x6f,
	0x52, 0x65, 0x63, 0x32, 0xb2, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x49, 0x0a, 0x06,
	0x56, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x56, 0x6b,
	0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0e, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x53, 0x65, 0x6c, 0x66, 0x55, 0x73, 0x65, 0x72, 0x22, 0x1a, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x14, 0x22, 0x0f, 0x2f, 0x76, 0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x76, 0x6b,
...
var file_user_user_proto_goTypes = []interface{}{
	...
	(*SelfUser)(nil),       // 4: user.SelfUser
}
var file_user_user_proto_depIdxs = []int32{
	3, // 0: user.User.VkAuth:input_type -> user.VkAuthRequest
	2, // 1: user.User.Auth:input_type -> user.AuthRequest
	1, // 2: user.User.GetById:input_type -> user.GetByIdRequest
	4, // 3: user.User.VkAuth:output_type -> user.SelfUser
	4, // 4: user.User.Auth:output_type -> user.SelfUser
	0, // 5: user.User.GetById:output_type -> user.ShortUser
