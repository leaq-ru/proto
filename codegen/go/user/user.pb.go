...
type VkAuthRequest struct {
	...
	PhotoRec  string `protobuf:"bytes,5,opt,name=photo_rec,json=photoRec,proto3" json:"photo_rec,omitempty"`
...
func (x *VkAuthRequest) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *VkAuthRequest) GetFirstName() string {
	if x != nil {
		return x.FirstName
	}
	return ""
...
func (x *VkAuthRequest) GetLastName() string {
	if x != nil {
		return x.LastName
	}
	return ""
...
func (x *VkAuthRequest) GetPhoto() string {
	if x != nil {
		return x.Photo
	}
	return ""
...
func (x *VkAuthRequest) GetPhotoRec() string {
	if x != nil {
		return x.PhotoRec
	}
	return ""
...
func (x *VkAuthRequest) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *SelfUser) GetVkId() string {
	if x != nil {
		return x.VkId
	}
	return ""
...
var file_user_user_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa4, 0x01, 0x0a, 0x0d, 0x56, 0x6b, 0x41, 0x75, 0x74, 0x68,
	...
	0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x70,
	0x68, 0x6f, 0x74, 0x6f, 0x5f, 0x72, 0x65, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x70, 0x68, 0x6f, 0x74, 0x6f, 0x52, 0x65, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73, 0x68,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0xb4, 0x01, 0x0a,
	...
	0x13, 0x0a, 0x05, 0x76, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	...
	,
...
var file_user_user_proto_goTypes = []interface{}{
	(*VkAuthRequest)(nil), // 0: user.VkAuthRequest
	(*SelfUser)(nil),      // 1: user.SelfUser
}
var file_user_user_proto_depIdxs = []int32{
	0, // 0: user.User.VkAuth:input_type -> user.VkAuthRequest
	1, // 1: user.User.VkAuth:output_type -> user.SelfUser
